...
The repo is my reflection after I learn how to configure `React`, `Webpack`, `Babel`, `Tailwind`, `Express`. 
...
Procedures is created after watching relevant YouTube videos. Those links will be mentioned in each section.
...
However, I don't want to download all those stuffs. I will use the following steps to create a react app. 
...
7. `"build:css": "postcss src/assets/tailwind.css -o src/assets/main.css"`,
8. `"watch:css": "postcss src/assets/tailwind.css -o src/assets/main.css"`, 
9. `npm start`
...
1. `npm start`: `"start": "webpack-dev-server --output-public-path=/build/"`, 
